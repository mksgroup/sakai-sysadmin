...
import org.sakaiproject.sysadmin.logic.ProjectLogic;
import org.sakaiproject.sysadmin.logic.SakaiProxy;
...
public class BaseController {
    ...
    void initSession(HttpServletRequest request, HttpSession httpSession) {
    	...
    	// On Sakai environment, try to load manually component
		if (sakaiProxy == null) {
			try {
